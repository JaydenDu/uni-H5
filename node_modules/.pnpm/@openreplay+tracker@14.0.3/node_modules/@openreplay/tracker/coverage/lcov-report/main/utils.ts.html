...
<head>
    <title>Code coverage report for main/utils.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">main</a> utils.ts</h1>
        <div class='clearfix'>
 ...
 * */
<span class="cstat-no" title="statement not covered" >export function <span class="fstat-no" title="function not covered" >n</span>gSafeBrowserMethod(</span>method: string): string {
  // @ts-ignore
<span class="cstat-no" title="statement not covered" >  return window.Zone &amp;&amp; '__symbol__' in window.Zone</span>
    ? // @ts-ignore
      window['Zone']['__symbol__'](method)
    : method
}
&nbsp;
<span class="cstat-no" title="statement not covered" >export function <span class="fstat-no" title="function not covered" >c</span>reateMutationObserver(</span>cb: MutationCallback) {
  const mObserver = <span class="cstat-no" title="statement not covered" >ngSafeBrowserMethod('MutationObserver') as 'MutationObserver'</span>
<span class="cstat-no" title="statement not covered" >  return new window[mObserver](cb)</span>
}
&nbsp;
<span class="cstat-no" title="statement not covered" >export function <span class="fstat-no" title="function not covered" >c</span>reateEventListener(</span>
  target: EventTarget,
  event: string,
