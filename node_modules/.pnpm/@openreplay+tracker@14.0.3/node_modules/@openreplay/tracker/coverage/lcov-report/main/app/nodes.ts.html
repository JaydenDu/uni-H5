...
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (id !== undefined) {</span>
      ;(<span class="cstat-no" title="statement not covered" >node as any)[this.node_id] = undefined</span>
...
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (!node) <span class="cstat-no" title="statement not covered" >return undefined</span></span>
...
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (!node) {</span>
