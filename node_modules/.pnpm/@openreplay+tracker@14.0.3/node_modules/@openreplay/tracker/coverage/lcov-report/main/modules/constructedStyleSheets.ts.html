...
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (styleSheets &amp;&amp; Symbol.iterator in styleSheets) {</span>
