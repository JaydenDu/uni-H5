...
<head>
    <title>Code coverage report for main/modules/userTesting/recorder.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">main/modules/userTesting</a> recorder.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  async <span class="fstat-no" title="function not covered" >saveToFile(</span>fileName = <span class="branch-0 cbranch-no" title="branch not covered" >'recorded-video.webm')</span> {
    ...
    const a = <span class="cstat-no" title="statement not covered" >document.createElement('a')</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  discard(</span>) {
<span class="cstat-no" title="statement not covered" >    this.mediaRecorder?.stop()</span>
<span class="cstat-no" title="statement not covered" >    this.stream?.getTracks().forEach(<span class="fstat-no" title="function not covered" >(t</span>rack) =&gt; <span class="cstat-no" title="statement not covered" >track.stop())</span></span>
  }
}
&nbsp;</pre></td></tr></table></pre>
