...
<span class="cstat-no" title="statement not covered" >      resources[entry.name] = entry.startTime + entry.duration</span>
    ...
    let shouldSkip = <span class="cstat-no" title="statement not covered" >false</span>
...
<span class="cstat-no" title="statement not covered" >        shouldSkip = true</span>
<span class="cstat-no" title="statement not covered" >        return</span>
      }
    })
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (shouldSkip) {</span>
<span class="cstat-no" title="statement not covered" >      return</span>
    }
