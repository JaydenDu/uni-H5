...
<head>
    <title>Code coverage report for main/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">main</a> index.ts</h1>
        <div class='clearfix'>
...
<a name='L505'></a><a href='#L505'>505</a></td><td class="line-coverage quiet"><span class="cline-any cline-no">&nbsp;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >import { UserAnonymousID, CustomEvent, CustomIssue } from './app/messages.gen.js'</span>
<span class="cstat-no" title="statement not covered" >import * as _Messages from './app/messages.gen.js'</span>
&nbsp;
export const <span class="cstat-no" title="statement not covered" >Messages = _Messages</span>
<span class="cstat-no" title="statement not covered" >export { <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >S</span>anitizeLevel </span>} from './app/sanitizer.js'</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >import Connection from './modules/connection.js'</span>
<span class="cstat-no" title="statement not covered" >import Console from './modules/console.js'</span>
<span class="cstat-no" title="statement not covered" >import Exception, {</span>
  getExceptionMessageFromEvent,
  getExceptionMessage,
} from './modules/exception.js'
<span class="cstat-no" title="statement not covered" >import Img from './modules/img.js'</span>
<span class="cstat-no" title="statement not covered" >import Input from './modules/input.js'</span>
<span class="cstat-no" title="statement not covered" >import Mouse from './modules/mouse.js'</span>
<span class="cstat-no" title="statement not covered" >import Timing from './modules/timing.js'</span>
<span class="cstat-no" title="statement not covered" >import Performance from './modules/performance.js'</span>
<span class="cstat-no" title="statement not covered" >import Scroll from './modules/scroll.js'</span>
<span class="cstat-no" title="statement not covered" >import Viewport from './modules/viewport.js'</span>
<span class="cstat-no" title="statement not covered" >import CSSRules from './modules/cssrules.js'</span>
<span class="cstat-no" title="statement not covered" >import Focus from './modules/focus.js'</span>
<span class="cstat-no" title="statement not covered" >import Fonts from './modules/fonts.js'</span>
<span class="cstat-no" title="statement not covered" >import Network from './modules/network.js'</span>
...
&nbsp;
const DOCS_SETUP = <span class="cstat-no" title="statement not covered" >'/installation/javascript-sdk'</span>
&nbsp;
function <span class="fstat-no" title="function not covered" >processOptions(</span>obj: any): obj is Options {
<span class="cstat-no" title="statement not covered" >  <span class="missing-if-branch" title="if path not taken" >I</span>if (obj == null) {</span>
...
<span class="cstat-no" title="statement not covered" >  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof obj.projectKey !== 'string') {</span>
<span class="cstat-no" title="statement not covered" >    if (typeof obj.projectKey !== 'number') {</span>
<span class="cstat-no" title="statement not covered" >      if (typeof obj.projectID !== 'number') {</span>
        // Back compatability
<span class="cstat-no" title="statement not covered" >        console.error(</span>
...
<span class="cstat-no" title="statement not covered" >        obj.projectKey = obj.projectID.toString()</span>
<span class="cstat-no" title="statement not covered" >        deprecationWarn('`projectID` option', '`projectKey` option', DOCS_SETUP)</span>
      }
    } else {
<span class="cstat-no" title="statement not covered" >      console.warn('OpenReplay: projectKey is expected to have a string type.')</span>
<span class="cstat-no" title="statement not covered" >      obj.projectKey = obj.projectKey.toString()</span>
    }
  }
<span class="cstat-no" title="statement not covered" >  <span class="missing-if-branch" title="if path not taken" >I</span>if (obj.sessionToken != null) {</span>
<span class="cstat-no" title="statement not covered" >    deprecationWarn('`sessionToken` option', '`sessionHash` start() option', '/')</span>
  }
...
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (!IN_BROWSER || !processOptions(options)) {</span>
<span class="cstat-no" title="statement not covered" >      return</span>
    }
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if ((window as any).__OPENREPLAY__) {</span>
<span class="cstat-no" title="statement not covered" >      console.error('OpenReplay: one tracker instance has been initialised already')</span>
<span class="cstat-no" title="statement not covered" >      return</span>
    }
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (!options.__DISABLE_SECURE_MODE &amp;&amp; location.protocol !== 'https:') {</span>
<span class="cstat-no" title="statement not covered" >      console.error(</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.flags &amp;&amp; options.flags.onFlagsLoad) {</span>
...
<span class="cstat-no" title="statement not covered" >          return wOpen.call(window, ...args)</span>
        }
      })
...
&nbsp;
<span class="fstat-no" title="function not covered" >  isActive(</span>): boolean {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.app === null) {</span>
<span class="cstat-no" title="statement not covered" >      return false</span>
    }
...
<span class="cstat-no" title="statement not covered" >    this.app.stop()</span>
<span class="cstat-no" title="statement not covered" >    return this.app.session.getSessionHash()</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    this.app.forceFlushBatch()</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  getSessionToken(</span>): string | null | undefined {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.app === null) {</span>
<span class="cstat-no" title="statement not covered" >      return null</span>
    }
<span class="cstat-no" title="statement not covered" >    return this.app.getSessionToken()</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  getSessionInfo(</span>): SessionInfo | null {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.app === null) {</span>
<span class="cstat-no" title="statement not covered" >      return null</span>
    }
<span class="cstat-no" title="statement not covered" >    return this.app.session.getInfo()</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  getSessionID(</span>): string | null | undefined {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.app === null) {</span>
<span class="cstat-no" title="statement not covered" >      return null</span>
    }
<span class="cstat-no" title="statement not covered" >    return this.app.getSessionID()</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    return this.app.getSessionURL(options)</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  setUserID(</span>id: string): void {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof id === 'string' &amp;&amp; this.app !== null) {</span>
<span class="cstat-no" title="statement not covered" >      this.app.session.setUserID(id)</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  userID(</span>id: string): void {
<span class="cstat-no" title="statement not covered" >    deprecationWarn("'userID' method", "'setUserID' method", '/')</span>
<span class="cstat-no" title="statement not covered" >    this.setUserID(id)</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  setUserAnonymousID(</span>id: string): void {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof id === 'string' &amp;&amp; this.app !== null) {</span>
<span class="cstat-no" title="statement not covered" >      this.app.send(UserAnonymousID(id))</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  userAnonymousID(</span>id: string): void {
<span class="cstat-no" title="statement not covered" >    deprecationWarn("'userAnonymousID' method", "'setUserAnonymousID' method", '/')</span>
<span class="cstat-no" title="statement not covered" >    this.setUserAnonymousID(id)</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  setMetadata(</span>key: string, value: string): void {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof key === 'string' &amp;&amp; typeof value === 'string' &amp;&amp; this.app !== null) {</span>
<span class="cstat-no" title="statement not covered" >      this.app.session.setMetadata(key, value)</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  metadata(</span>key: string, value: string): void {
<span class="cstat-no" title="statement not covered" >    deprecationWarn("'metadata' method", "'setMetadata' method", '/')</span>
<span class="cstat-no" title="statement not covered" >    this.setMetadata(key, value)</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  event(</span>key: string, payload: any = <span class="branch-0 cbranch-no" title="branch not covered" >null,</span> issue = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span>: void {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof key === 'string' &amp;&amp; this.app !== null) {</span>
<span class="cstat-no" title="statement not covered" >      if (issue) {</span>
<span class="cstat-no" title="statement not covered" >        return this.issue(key, payload)</span>
      } else {
...
<span class="cstat-no" title="statement not covered" >        this.app.send(CustomEvent(key, payload))</span>
      }
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  issue(</span>key: string, payload: any = <span class="branch-0 cbranch-no" title="branch not covered" >null)</span>: void {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof key === 'string' &amp;&amp; this.app !== null) {</span>
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        payload = JSON.stringify(payload)</span>
      } catch (e) {
...
<span class="cstat-no" title="statement not covered" >      this.app.send(CustomIssue(key, payload))</span>
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  handleError = <span class="fstat-no" title="function not covered" >(</span></span>
    e: Error | ErrorEvent | PromiseRejectionEvent,
    metadata: Record&lt;string, any&gt; = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span>
  ) =&gt; {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.app === null) {</span>
<span class="cstat-no" title="statement not covered" >      return</span>
    }
<span class="cstat-no" title="statement not covered" >    if (e instanceof Error) {</span>
      const msg = <span class="cstat-no" title="statement not covered" >getExceptionMessage(e, [], metadata)</span>
<span class="cstat-no" title="statement not covered" >      this.app.send(msg)</span>
      ...
      const msg = <span class="cstat-no" title="statement not covered" >getExceptionMessageFromEvent(e, undefined, metadata)</span>
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (msg != null) {</span>
<span class="cstat-no" title="statement not covered" >        this.app.send(msg)</span>
      }
    }
  }
