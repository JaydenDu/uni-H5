...
<head>
    <title>Code coverage report for main/modules/Network/beaconProxy.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">main/modules/Network</a> beaconProxy.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >  <span class="missing-if-branch" title="if path not taken" >I</span>if (data instanceof FormData) {</span>
<span class="cstat-no" title="statement not covered" >    return 'multipart/form-data'</span>
  }
<span class="cstat-no" title="statement not covered" >  <span class="missing-if-branch" title="if path not taken" >I</span>if (data instanceof URLSearchParams) {</span>
...
&nbsp;
  public <span class="fstat-no" title="function not covered" >apply(</span>target: T, thisArg: T, argsList: any[]) {
...
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isServiceUrl(urlString)) {</span>
...
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (!BeaconProxy.hasSendBeacon()) {</span>
