...
<head>
    <title>Code coverage report for main/modules/Network/utils.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">main/modules/Network</a> utils.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >          result = response.slice(0, 10000)</span>
      ...
      } else <span class="cstat-no" title="statement not covered" >if (isPureObject(response) || Array.isArray(response)) {</span>
<span class="cstat-no" title="statement not covered" >        result = JSON.stringify(response)</span>
      } else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="if path not taken" >I</span>if (typeof response !== 'undefined') {</span>
...
&nbsp;
    ...
    case 'arraybuffer':
    default:
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof response !== 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >        result = Object.prototype.toString.call(response)</span>
      }
<span class="cstat-no" title="statement not covered" >      break</span>
  }
...
<span class="cstat-no" title="statement not covered" >  switch (responseType) {</span>
    ...
    case 'json':
<span class="cstat-no" title="statement not covered" >      if (typeof response == 'string') {</span>
<span class="cstat-no" title="statement not covered" >        result = response</span>
      } else <span class="cstat-no" title="statement not covered" >if (isPureObject(response) || Array.isArray(response)) {</span>
<span class="cstat-no" title="statement not covered" >        result = JSON.stringify(response)</span>
      } else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="if path not taken" >I</span>if (typeof response !== 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >        result = Object.prototype.toString.call(response)</span>
...
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (body[0] === '{' || body[0] === '[') {</span>
<span class="cstat-no" title="statement not covered" >      result = body</span>
    }
    // 'a=1&amp;b=2' =&gt; try to parse as query
    const arr = <span class="cstat-no" title="statement not covered" >body.split('&amp;')</span>
...
<span class="cstat-no" title="statement not covered" >      result = arr.join(',')</span>
  ...
  } else <span class="cstat-no" title="statement not covered" >if (isIterable(body)) {</span>
    // FormData or URLSearchParams or Array
    const arr = <span class="cstat-no" title="statement not covered" >[]</span>
<span class="cstat-no" title="statement not covered" >    for (const [key, value] of &lt;FormData | URLSearchParams&gt;body) {</span>
<span class="cstat-no" title="statement not covered" >      arr.push(`${key}=${typeof value === 'string' ? value : '[object Object]'}`)</span>
    }
<span class="cstat-no" title="statement not covered" >    result = arr.join(',')</span>
...
<span class="cstat-no" title="statement not covered" >    getData = {}</span>
  ...
  let query: string[] = <span class="cstat-no" title="statement not covered" >url ? url.split('?') : [] </span>// a.php?b=c&amp;d=?e =&gt; ['a.php', 'b=c&amp;d=', 'e']
<span class="cstat-no" title="statement not covered" >  query.shift() /</span>/ =&gt; ['b=c&amp;d=', 'e']
<span class="cstat-no" title="statement not covered" >  <span class="missing-if-branch" title="if path not taken" >I</span>if (query.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >    query = query.join('?').split('&amp;') /</span>/ =&gt; 'b=c&amp;d=?e' =&gt; ['b=c', 'd=?e']
<span class="cstat-no" title="statement not covered" >    for (const q of query) {</span>
      const kv = <span class="cstat-no" title="statement not covered" >q.split('=')</span>
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        getData[kv[0]] = decodeURIComponent(kv[1])</span>
      } catch (e) {
...
<span class="cstat-no" title="statement not covered" >      for (let q of arr) {</span>
        const kv = <span class="cstat-no" title="statement not covered" >q.split('=')</span>
<span class="cstat-no" title="statement not covered" >        result[kv[0]] = kv[1] === undefined ? 'undefined' : kv[1]</span>
      }
    }
  } else <span class="cstat-no" title="statement not covered" >if (isIterable(body)) {</span>
    // FormData or URLSearchParams or Array
...
<span class="cstat-no" title="statement not covered" >  <span class="missing-if-branch" title="if path not taken" >I</span>if (bytes &gt;= 1000 * 1000) {</span>
<span class="cstat-no" title="statement not covered" >    return (bytes / 1000 / 1000).toFixed(1) + ' MB'</span>
  }
<span class="cstat-no" title="statement not covered" >  <span class="missing-if-branch" title="if path not taken" >I</span>if (bytes &gt;= 1000) {</span>
<span class="cstat-no" title="statement not covered" >    return (bytes / 1000).toFixed(1) + ' KB'</span>
  }
