...
<head>
    <title>Code coverage report for main/modules/viewport.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">main/modules</a> viewport.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  const sendSetPageLocation = <span class="cstat-no" title="statement not covered" >app.safe(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
...
&nbsp;
  const sendSetViewportSize = <span class="cstat-no" title="statement not covered" >app.safe(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
    const { innerWidth, innerHeight } = <span class="cstat-no" title="statement not covered" >window</span>
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (innerWidth !== width || innerHeight !== height) {</span>
<span class="cstat-no" title="statement not covered" >      width = innerWidth</span>
<span class="cstat-no" title="statement not covered" >      height = innerHeight</span>
<span class="cstat-no" title="statement not covered" >      app.send(SetViewportSize(width, height))</span>
    }
  })
&nbsp;
  const sendSetPageVisibility =
<span class="cstat-no" title="statement not covered" >    document.hidden === undefined</span>
      ? Function.prototype
...
<span class="cstat-no" title="statement not covered" >    sendSetViewportSize()</span>
<span class="cstat-no" title="statement not covered" >    sendSetPageVisibility()</span>
  })
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  app.ticker.attach(sendSetPageLocation, 1, false)</span>
<span class="cstat-no" title="statement not covered" >  app.ticker.attach(sendSetViewportSize, 5, false)</span>
}
&nbsp;</pre></td></tr></table></pre>
