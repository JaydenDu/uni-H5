...
<head>
    <title>Code coverage report for main/modules/Network/fetchProxy.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">main/modules/Network</a> fetchProxy.ts</h1>
        <div class='clearfix'>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  constructor(r</span>esp: T, item: NetworkMessage) {
<span class="cstat-no" title="statement not covered" >    this.resp = resp</span>
<span class="cstat-no" title="statement not covered" >    this.item = item</span>
<span class="cstat-no" title="statement not covered" >    this.mockReader()</span>
  }
&nbsp;
  public <span class="fstat-no" title="function not covered" >set(</span>target: T, key: string, value: (args: any[]) =&gt; any) {
<span class="cstat-no" title="statement not covered" >    return Reflect.set(target, key, value)</span>
  }
&nbsp;
  public <span class="fstat-no" title="function not covered" >get(</span>target: T, key: string) {
...
<span class="cstat-no" title="statement not covered" >          this.item.responseType = &lt;any&gt;key.toLowerCase()</span>
          // @ts-ignore
<span class="cstat-no" title="statement not covered" >          return value.apply(target).then(<span class="fstat-no" title="function not covered" >(r</span>esp: any) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            this.item.response = getStringResponseByType(this.item.responseType, resp)</span>
...
&nbsp;
  protected <span class="fstat-no" title="function not covered" >mockReader(</span>) {
    let readerReceivedValue: Uint8Array
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.resp.body) {</span>
      // some browsers do not return `body` in some cases, like `OPTIONS` method
<span class="cstat-no" title="statement not covered" >      return</span>
    }
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof this.resp.body.getReader !== 'function') {</span>
<span class="cstat-no" title="statement not covered" >      return</span>
    }
    const _getReader = <span class="cstat-no" title="statement not covered" >this.resp.body.getReader</span>
    // @ts-ignore
<span class="cstat-no" title="statement not covered" >    this.resp.body.getReader = <span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
      const reader = &lt;ReturnType&lt;typeof _getReader&gt;&gt;<span class="cstat-no" title="statement not covered" >_getReader.apply(this.resp.body)</span>
&nbsp;
      // when readyState is already 4,
      // it's not a chunked stream, or it had already been read.
      // so should not update status.
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.item.readyState === RequestState.DONE) {</span>
<span class="cstat-no" title="statement not covered" >        return reader</span>
      }
&nbsp;
      const _read = <span class="cstat-no" title="statement not covered" >reader.read</span>
      const _cancel = <span class="cstat-no" title="statement not covered" >reader.cancel</span>
<span class="cstat-no" title="statement not covered" >      this.item.responseType = 'arraybuffer'</span>
&nbsp;
      // @ts-ignore
<span class="cstat-no" title="statement not covered" >      reader.read = <span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
<span class="cstat-no" title="statement not covered" >        return (&lt;ReturnType&lt;typeof _read&gt;&gt;_read.apply(reader)).then(</span>
<span class="fstat-no" title="function not covered" >          (r</span>esult: ReadableStreamReadResult&lt;Uint8Array&gt;) =&gt; {
<span class="cstat-no" title="statement not covered" >            if (!readerReceivedValue) {</span>
              // @ts-ignore
<span class="cstat-no" title="statement not covered" >              readerReceivedValue = new Uint8Array(result.value)</span>
            } else {
              // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
              const newValue = <span class="cstat-no" title="statement not covered" >new Uint8Array(readerReceivedValue.length + result.value!.length)</span>
<span class="cstat-no" title="statement not covered" >              newValue.set(readerReceivedValue)</span>
              // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
<span class="cstat-no" title="statement not covered" >              newValue.set(result.value!, readerReceivedValue.length)</span>
<span class="cstat-no" title="statement not covered" >              readerReceivedValue = newValue</span>
            }
...
<span class="cstat-no" title="statement not covered" >            this.item.readyState = result.done ? 4 : 3</span>
<span class="cstat-no" title="statement not covered" >            this.item.statusText = result.done ? String(this.item.status) : 'Loading'</span>
<span class="cstat-no" title="statement not covered" >            this.item.responseSize = readerReceivedValue.length</span>
<span class="cstat-no" title="statement not covered" >            this.item.responseSizeText = formatByteSize(this.item.responseSize)</span>
<span class="cstat-no" title="statement not covered" >            <span class="missing-if-branch" title="if path not taken" >I</span>if (result.done) {</span>
<span class="cstat-no" title="statement not covered" >              this.item.response = getStringResponseByType(</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      reader.cancel = <span class="fstat-no" title="function not covered" >(.</span>..args) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        this.item.cancelState = 2</span>
<span class="cstat-no" title="statement not covered" >        this.item.statusText = 'Cancel'</span>
<span class="cstat-no" title="statement not covered" >        this.item.endTime = performance.now()</span>
<span class="cstat-no" title="statement not covered" >        this.item.duration = this.item.endTime - (this.item.startTime || this.item.endTime)</span>
<span class="cstat-no" title="statement not covered" >        this.item.response = getStringResponseByType(this.item.responseType, readerReceivedValue)</span>
<span class="cstat-no" title="statement not covered" >        return _cancel.apply(reader, args)</span>
      }
<span class="cstat-no" title="statement not covered" >      return reader</span>
    }
  }
...
<span class="cstat-no" title="statement not covered" >      if (argsList[1] === undefined &amp;&amp; argsList[0] instanceof Request) {</span>
<span class="cstat-no" title="statement not covered" >        return argsList[0].headers.append(name, value)</span>
      } else {
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (!argsList[1]) <span class="cstat-no" title="statement not covered" >argsList[1] = {}</span></span>
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (argsList[1].headers === undefined) {</span>
<span class="cstat-no" title="statement not covered" >          argsList[1] = { ...argsList[1], headers: {} }</span>
        }
<span class="cstat-no" title="statement not covered" >        if (argsList[1].headers instanceof Headers) {</span>
<span class="cstat-no" title="statement not covered" >          argsList[1].headers.append(name, value)</span>
        } else <span class="cstat-no" title="statement not covered" >if (Array.isArray(argsList[1].headers)) {</span>
<span class="cstat-no" title="statement not covered" >          argsList[1].headers.push([name, value])</span>
        } else {
          // @ts-ignore
<span class="cstat-no" title="statement not covered" >          argsList[1].headers[name] = value</span>
        }
      }
    })
<span class="cstat-no" title="statement not covered" >    return (&lt;ReturnType&lt;T&gt;&gt;target.apply(window, argsList))</span>
...
&nbsp;
  protected <span class="fstat-no" title="function not covered" >afterFetch(</span>item: NetworkMessage) {
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >(r</span>esp: Response) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      item.endTime = performance.now()</span>
<span class="cstat-no" title="statement not covered" >      item.duration = item.endTime - (item.startTime || item.endTime)</span>
<span class="cstat-no" title="statement not covered" >      item.status = resp.status</span>
<span class="cstat-no" title="statement not covered" >      item.statusText = String(resp.status)</span>
&nbsp;
      let isChunked = <span class="cstat-no" title="statement not covered" >false</span>
<span class="cstat-no" title="statement not covered" >      item.header = {}</span>
<span class="cstat-no" title="statement not covered" >      for (const [key, value] of resp.headers) {</span>
<span class="cstat-no" title="statement not covered" >        item.header[key] = value</span>
<span class="cstat-no" title="statement not covered" >        isChunked = value.toLowerCase().indexOf('chunked') &gt; -1 ? true : isChunked</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (isChunked) {</span>
...
<span class="cstat-no" title="statement not covered" >        item.readyState = 3</span>
      } else {
...
&nbsp;
  protected <span class="fstat-no" title="function not covered" >handleResponseBody(</span>resp: Response, item: NetworkMessage) {
    // parse response body by Content-Type
    const contentType = <span class="cstat-no" title="statement not covered" >resp.headers.get('content-type')</span>
<span class="cstat-no" title="statement not covered" >    if (contentType &amp;&amp; contentType.includes('application/json')) {</span>
<span class="cstat-no" title="statement not covered" >      item.responseType = 'json'</span>
<span class="cstat-no" title="statement not covered" >      return resp.text()</span>
    } else <span class="cstat-no" title="statement not covered" >if (</span>
      contentType &amp;&amp;
      (contentType.includes('text/html') || contentType.includes('text/plain'))
    ) {
<span class="cstat-no" title="statement not covered" >      item.responseType = 'text'</span>
<span class="cstat-no" title="statement not covered" >      return resp.text()</span>
    } else {
<span class="cstat-no" title="statement not covered" >      item.responseType = 'arraybuffer'</span>
<span class="cstat-no" title="statement not covered" >      return resp.arrayBuffer()</span>
    }
  }
}
&nbsp;
