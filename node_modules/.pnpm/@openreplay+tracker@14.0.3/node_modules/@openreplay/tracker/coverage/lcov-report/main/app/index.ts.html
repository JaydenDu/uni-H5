...
<head>
    <title>Code coverage report for main/app/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">main/app</a> index.ts</h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>0/493</span>
            </div>
...
<a name='L1291'></a><a href='#L1291'>1291</a></td><td class="line-coverage quiet"><span class="cline-any cline-no">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >import Nodes from './nodes.js'</span>
...
const bufferStorageKey = <span class="cstat-no" title="statement not covered" >'or_buffer_1'</span>
...
const SuccessfulStart = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(b</span>ody: OnStartInfo): SuccessfulStart =&gt; <span class="cstat-no" title="statement not covered" >({ ...body, success: true })</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >enum A</span>ctivityState {</span>
<span class="cstat-no" title="statement not covered" >  NotActive,</span>
<span class="cstat-no" title="statement not covered" >  Starting,</span>
<span class="cstat-no" title="statement not covered" >  Active,</span>
<span class="cstat-no" title="statement not covered" >  ColdStart,</span>
}
&nbsp;
type AppOptions = {
  revID: string
...
export const <span class="cstat-no" title="statement not covered" >DEFAULT_INGEST_POINT = 'https://api.openreplay.com/ingest'</span>
&nbsp;
function <span class="fstat-no" title="function not covered" >getTimezone(</span>) {
  const offset = <span class="cstat-no" title="statement not covered" >new Date().getTimezoneOffset() * -1</span>
  const sign = <span class="cstat-no" title="statement not covered" >offset &gt;= 0 ? '+' : '-'</span>
  const hours = <span class="cstat-no" title="statement not covered" >Math.floor(Math.abs(offset) / 60)</span>
  const minutes = <span class="cstat-no" title="statement not covered" >Math.abs(offset) % 60</span>
<span class="cstat-no" title="statement not covered" >  return `UTC${sign}${String(hours).padStart(2, '0')}:${String(minutes).padStart(2, '0')}`</span>
}
&nbsp;
<span class="cstat-no" title="statement not covered" >export default class A</span>pp {
  ...
  private readonly <span class="cstat-no" title="statement not covered" >bufferedMessages2: Array&lt;Message&gt; = []</span>
  /* private */
...
&nbsp;
  ...
  public <span class="cstat-no" title="statement not covered" >socketMode = false</span>
  ...
  private readonly <span class="cstat-no" title="statement not covered" >bc: BroadcastChannel | null = null</span>
...
<span class="fstat-no" title="function not covered" >  constructor(</span>
    ...
    private readonly <span class="cstat-no" title="statement not covered" >signalError: (error: string, apis: string[]) =&gt; void,</span>
  ) {
<span class="cstat-no" title="statement not covered" >    this.contextId = Math.random().toString(36).slice(2)</span>
<span class="cstat-no" title="statement not covered" >    this.projectKey = projectKey</span>
<span class="cstat-no" title="statement not covered" >    this.networkOptions = options.network</span>
...
<span class="cstat-no" title="statement not covered" >    this.localStorage = this.options.localStorage ?? window.localStorage</span>
<span class="cstat-no" title="statement not covered" >    this.sessionStorage = this.options.sessionStorage ?? window.sessionStorage</span>
<span class="cstat-no" title="statement not covered" >    this.sanitizer = new Sanitizer(this, options)</span>
<span class="cstat-no" title="statement not covered" >    this.nodes = new Nodes(this.options.node_id)</span>
<span class="cstat-no" title="statement not covered" >    this.observer = new Observer(this, options)</span>
...
<span class="cstat-no" title="statement not covered" >        this.send(UserID(userID))</span>
      }
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (metadata != null) {</span>
<span class="cstat-no" title="statement not covered" >        Object.entries(metadata).forEach(<span class="fstat-no" title="function not covered" >([</span>key, value]) =&gt; <span class="cstat-no" title="statement not covered" >this.send(Metadata(key, value)))</span></span>
      }
    })
&nbsp;
    // @deprecated (use sessionHash on start instead)
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (sessionToken != null) {</span>
<span class="cstat-no" title="statement not covered" >      this.session.applySessionHash(sessionToken)</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      this.worker = new Worker(</span>
        URL.createObjectURL(new Blob(['WEBWORKER_BODY'], { type: 'text/javascript' })),
      )
<span class="cstat-no" title="statement not covered" >      this.worker.onerror = <span class="fstat-no" title="function not covered" >(e</span>) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        this._debug('webworker_error', e)</span>
      }
<span class="cstat-no" title="statement not covered" >      this.worker.onmessage = <span class="fstat-no" title="function not covered" >({</span> data }: MessageEvent&lt;FromWorkerData&gt;) =&gt; {</span>
        // handling 401 auth restart (new token assignment)
<span class="cstat-no" title="statement not covered" >        if (data === 'a_stop') {</span>
<span class="cstat-no" title="statement not covered" >          this.stop(false)</span>
        } else <span class="cstat-no" title="statement not covered" >if (data === 'a_start') {</span>
...
<span class="cstat-no" title="statement not covered" >          this.worker.postMessage(null)</span>
        }
      }
      // keep better tactics, discard others?
<span class="cstat-no" title="statement not covered" >      this.attachEventListener(window, 'beforeunload', alertWorker, false)</span>
<span class="cstat-no" title="statement not covered" >      this.attachEventListener(document.body, 'mouseleave', alertWorker, false, false)</span>
      // TODO: stop session after inactivity timeout (make configurable)
<span class="cstat-no" title="statement not covered" >      this.attachEventListener(document, 'visibilitychange', alertWorker, false)</span>
    } catch (e) {
<span class="cstat-no" title="statement not covered" >      this._debug('worker_start', e)</span>
    }
&nbsp;
    const thisTab = <span class="cstat-no" title="statement not covered" >this.session.getTabId()</span>
&nbsp;
    const proto = <span class="cstat-no" title="statement not covered" >{</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.bc) {</span>
<span class="cstat-no" title="statement not covered" >      this.bc.postMessage({</span>
        line: proto.ask,
        source: thisTab,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.bc !== null) {</span>
<span class="cstat-no" title="statement not covered" >      this.bc.onmessage = <span class="fstat-no" title="function not covered" >(e</span>v: MessageEvent&lt;RickRoll&gt;) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (ev.data.context === this.contextId) {</span>
<span class="cstat-no" title="statement not covered" >          return</span>
        }
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (ev.data.line === proto.resp) {</span>
          const sessionToken = <span class="cstat-no" title="statement not covered" >ev.data.token</span>
<span class="cstat-no" title="statement not covered" >          this.session.setSessionToken(sessionToken)</span>
        }
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (ev.data.line === proto.reg) {</span>
          const sessionToken = <span class="cstat-no" title="statement not covered" >ev.data.token</span>
<span class="cstat-no" title="statement not covered" >          this.session.regenerateTabId()</span>
<span class="cstat-no" title="statement not covered" >          this.session.setSessionToken(sessionToken)</span>
        }
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (ev.data.line === proto.ask) {</span>
          const token = <span class="cstat-no" title="statement not covered" >this.session.getSessionToken()</span>
<span class="cstat-no" title="statement not covered" >          <span class="missing-if-branch" title="if path not taken" >I</span>if (token &amp;&amp; this.bc) {</span>
<span class="cstat-no" title="statement not covered" >            this.bc.postMessage({</span>
...
&nbsp;
  private <span class="fstat-no" title="function not covered" >_debug(</span>context: string, e: any) {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.__debug_report_edp !== null) {</span>
<span class="cstat-no" title="statement not covered" >      void fetch(this.options.__debug_report_edp, {</span>
        method: 'POST',
...
<span class="cstat-no" title="statement not covered" >    this.debug.error('OpenReplay error: ', context, e)</span>
  }
&nbsp;
  private <span class="cstat-no" title="statement not covered" >_usingOldFetchPlugin = false</span>
&nbsp;
<span class="fstat-no" title="function not covered" >  send(</span>message: Message, urgent = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span>: void {
...
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (message[0] === MType.Fetch) {</span>
<span class="cstat-no" title="statement not covered" >      this._usingOldFetchPlugin = true</span>
<span class="cstat-no" title="statement not covered" >      deprecationWarn('Fetch plugin', "'network' init option", '/installation/network-options')</span>
<span class="cstat-no" title="statement not covered" >      deprecationWarn('Axios plugin', "'network' init option", '/installation/network-options')</span>
    }
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this._usingOldFetchPlugin &amp;&amp; message[0] === MType.NetworkRequest) {</span>
<span class="cstat-no" title="statement not covered" >      return</span>
    }
&nbsp;
    // ====================================================
<span class="cstat-no" title="statement not covered" >    if (this.activityState === ActivityState.ColdStart) {</span>
<span class="cstat-no" title="statement not covered" >      this.bufferedMessages1.push(message)</span>
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.singleBuffer) {</span>
<span class="cstat-no" title="statement not covered" >        this.bufferedMessages2.push(message)</span>
      }
<span class="cstat-no" title="statement not covered" >      this.conditionsManager?.processMessage(message)</span>
    } else {
...
&nbsp;
   ...
   * every ~30ms
   * */
  private <span class="fstat-no" title="function not covered" >_nCommit(</span>): void {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.socketMode) {</span>
<span class="cstat-no" title="statement not covered" >      this.messages.unshift(TabData(this.session.getTabId()))</span>
<span class="cstat-no" title="statement not covered" >      this.messages.unshift(Timestamp(this.timestamp()))</span>
<span class="cstat-no" title="statement not covered" >      this.commitCallbacks.forEach(<span class="fstat-no" title="function not covered" >(c</span>b) =&gt; <span class="cstat-no" title="statement not covered" >cb(this.messages))</span></span>
<span class="cstat-no" title="statement not covered" >      this.messages.length = 0</span>
<span class="cstat-no" title="statement not covered" >      return</span>
    }
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.worker !== undefined &amp;&amp; this.messages.length) {</span>
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        requestIdleCb(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
<span class="cstat-no" title="statement not covered" >          this.messages.unshift(TabData(this.session.getTabId()))</span>
<span class="cstat-no" title="statement not covered" >          this.messages.unshift(Timestamp(this.timestamp()))</span>
          // why I need to add opt chaining?
<span class="cstat-no" title="statement not covered" >          this.worker?.postMessage(this.messages)</span>
<span class="cstat-no" title="statement not covered" >          this.commitCallbacks.forEach(<span class="fstat-no" title="function not covered" >(c</span>b) =&gt; <span class="cstat-no" title="statement not covered" >cb(this.messages))</span></span>
<span class="cstat-no" title="statement not covered" >          this.messages.length = 0</span>
        })
      } catch (e) {
<span class="cstat-no" title="statement not covered" >        this._debug('worker_commit', e)</span>
<span class="cstat-no" title="statement not covered" >        this.stop(true)</span>
<span class="cstat-no" title="statement not covered" >        setTimeout(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
<span class="cstat-no" title="statement not covered" >          void this.start()</span>
        }, 500)
      }
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  coldStartCommitN = 0</span>
&nbsp;
  /**
   ...
   * */
  private <span class="fstat-no" title="function not covered" >_cStartCommit(</span>): void {
<span class="cstat-no" title="statement not covered" >    this.coldStartCommitN += 1</span>
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.coldStartCommitN === 2) {</span>
<span class="cstat-no" title="statement not covered" >      this.bufferedMessages1.push(Timestamp(this.timestamp()))</span>
<span class="cstat-no" title="statement not covered" >      this.bufferedMessages1.push(TabData(this.session.getTabId()))</span>
<span class="cstat-no" title="statement not covered" >      this.bufferedMessages2.push(Timestamp(this.timestamp()))</span>
<span class="cstat-no" title="statement not covered" >      this.bufferedMessages2.push(TabData(this.session.getTabId()))</span>
<span class="cstat-no" title="statement not covered" >      this.coldStartCommitN = 0</span>
    }
  }
&nbsp;
  private <span class="fstat-no" title="function not covered" >commit(</span>): void {
<span class="cstat-no" title="statement not covered" >    if (this.activityState === ActivityState.ColdStart) {</span>
<span class="cstat-no" title="statement not covered" >      this._cStartCommit()</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this._nCommit()</span>
    }
  }
&nbsp;
  private <span class="fstat-no" title="function not covered" >postToWorker(</span>messages: Array&lt;Message&gt;) {
<span class="cstat-no" title="statement not covered" >    this.worker?.postMessage(messages)</span>
<span class="cstat-no" title="statement not covered" >    this.commitCallbacks.forEach(<span class="fstat-no" title="function not covered" >(c</span>b) =&gt; <span class="cstat-no" title="statement not covered" >cb(messages))</span></span>
<span class="cstat-no" title="statement not covered" >    messages.length = 0</span>
  }
&nbsp;
  private <span class="cstat-no" title="statement not covered" >delay = 0</span>
&nbsp;
<span class="fstat-no" title="function not covered" >  timestamp(</span>): number {
<span class="cstat-no" title="statement not covered" >    return now() + this.delay</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  safe&lt;</span>T extends (this: any, ...args: any[]) =&gt; void&gt;(fn: T): T {
    const app = <span class="cstat-no" title="statement not covered" >this</span>
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >function (this: any, .</span>..args: any[]) {</span>
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        fn.apply(this, args)</span>
      } catch (e) {
<span class="cstat-no" title="statement not covered" >        app._debug('safe_fn_call', e)</span>
        // time: this.timestamp(),
        // name: e.name,
        // message: e.message,
        // stack: e.stack
...
&nbsp;
<span class="fstat-no" title="function not covered" >  attachCommitCallback(</span>cb: CommitCallback): void {
<span class="cstat-no" title="statement not covered" >    this.commitCallbacks.push(cb)</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  attachStartCallback(</span>cb: StartCallback, useSafe = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span>: void {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (useSafe) {</span>
<span class="cstat-no" title="statement not covered" >      cb = this.safe(cb)</span>
    }
<span class="cstat-no" title="statement not covered" >    this.startCallbacks.push(cb)</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  attachStopCallback(</span>cb: () =&gt; any, useSafe = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span>: void {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (useSafe) {</span>
<span class="cstat-no" title="statement not covered" >      cb = this.safe(cb)</span>
    }
<span class="cstat-no" title="statement not covered" >    this.stopCallbacks.push(cb)</span>
  }
&nbsp;
  // Use  app.nodes.attachNodeListener for registered nodes instead
<span class="fstat-no" title="function not covered" >  attachEventListener(</span>
    target: EventTarget,
    type: string,
    listener: EventListener,
    useSafe = <span class="branch-0 cbranch-no" title="branch not covered" >true,</span>
    useCapture = <span class="branch-0 cbranch-no" title="branch not covered" >true,</span>
  ): void {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (useSafe) {</span>
<span class="cstat-no" title="statement not covered" >      listener = this.safe(listener)</span>
    }
<span class="cstat-no" title="statement not covered" >    this.attachStartCallback(</span>
<span class="fstat-no" title="function not covered" >      () =</span>&gt; (<span class="cstat-no" title="statement not covered" >target ? createEventListener(target, type, listener, useCapture) : null)</span>,
      useSafe,
    )
<span class="cstat-no" title="statement not covered" >    this.attachStopCallback(</span>
<span class="fstat-no" title="function not covered" >      () =</span>&gt; (<span class="cstat-no" title="statement not covered" >target ? deleteEventListener(target, type, listener, useCapture) : null)</span>,
      useSafe,
    )
  }
&nbsp;
  // TODO: full correct semantic
<span class="fstat-no" title="function not covered" >  checkRequiredVersion(</span>version: string): boolean {
    const reqVer = <span class="cstat-no" title="statement not covered" >version.split(/[.-]/)</span>
    const ver = <span class="cstat-no" title="statement not covered" >this.version.split(/[.-]/)</span>
...
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (isNaN(Number(ver[i])) || isNaN(Number(reqVer[i]))) {</span>
<span class="cstat-no" title="statement not covered" >        return false</span>
      }
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (Number(ver[i]) &gt; Number(reqVer[i])) {</span>
...
&nbsp;
  private <span class="fstat-no" title="function not covered" >getTrackerInfo(</span>) {
<span class="cstat-no" title="statement not covered" >    return {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  getSessionInfo(</span>) {
<span class="cstat-no" title="statement not covered" >    return {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  getSessionToken(</span>): string | undefined {
<span class="cstat-no" title="statement not covered" >    return this.session.getSessionToken()</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  getSessionID(</span>): string | undefined {
<span class="cstat-no" title="statement not covered" >    return this.session.getInfo().sessionID || undefined</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  getSessionURL(</span>options?: { withCurrentTime?: boolean }): string | undefined {
    const { projectID, sessionID, timestamp } = <span class="cstat-no" title="statement not covered" >this.session.getInfo()</span>
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (!projectID || !sessionID) {</span>
<span class="cstat-no" title="statement not covered" >      this.debug.error('OpenReplay error: Unable to build session URL')</span>
<span class="cstat-no" title="statement not covered" >      return undefined</span>
    }
    const ingest = <span class="cstat-no" title="statement not covered" >this.options.ingestPoint</span>
    const isSaas = <span class="cstat-no" title="statement not covered" >/api\.openreplay\.com/.test(ingest)</span>
&nbsp;
    const projectPath = <span class="cstat-no" title="statement not covered" >isSaas ? 'https://app.openreplay.com/ingest' : ingest</span>
&nbsp;
    const url = <span class="cstat-no" title="statement not covered" >projectPath.replace(/ingest$/, `${projectID}/session/${sessionID}`)</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (options?.withCurrentTime) {</span>
      const jumpTo = <span class="cstat-no" title="statement not covered" >now() - timestamp</span>
<span class="cstat-no" title="statement not covered" >      return `${url}?jumpto=${jumpTo}`</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return url</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  getHost(</span>): string {
<span class="cstat-no" title="statement not covered" >    return new URL(this.options.ingestPoint).host</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  getProjectKey(</span>): string {
<span class="cstat-no" title="statement not covered" >    return this.projectKey</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  getBaseHref(</span>): string {
<span class="cstat-no" title="statement not covered" >    if (typeof this.options.resourceBaseHref === 'string') {</span>
<span class="cstat-no" title="statement not covered" >      return this.options.resourceBaseHref</span>
    } else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="if path not taken" >I</span>if (typeof this.options.resourceBaseHref === 'object') {</span>
      //TODO: switch between types
    }
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (document.baseURI) {</span>
<span class="cstat-no" title="statement not covered" >      return document.baseURI</span>
    }
    // IE only
<span class="cstat-no" title="statement not covered" >    return (</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  resolveResourceURL(</span>resourceURL: string): string {
    const base = <span class="cstat-no" title="statement not covered" >new URL(this.getBaseHref())</span>
<span class="cstat-no" title="statement not covered" >    base.pathname += '/' + new URL(resourceURL).pathname</span>
<span class="cstat-no" title="statement not covered" >    base.pathname.replace(/\/+/g, '/')</span>
<span class="cstat-no" title="statement not covered" >    return base.toString()</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  isServiceURL(</span>url: string): boolean {
<span class="cstat-no" title="statement not covered" >    return url.startsWith(this.options.ingestPoint)</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  active(</span>): boolean {
...
<span class="cstat-no" title="statement not covered" >      this.sessionStorage.removeItem(this.options.session_reset_key)</span>
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  coldInterval: ReturnType&lt;typeof setInterval&gt; | null = null</span>
<span class="cstat-no" title="statement not covered" >  orderNumber = 0</span>
<span class="cstat-no" title="statement not covered" >  coldStartTs = 0</span>
<span class="cstat-no" title="statement not covered" >  singleBuffer = false</span>
&nbsp;
  private <span class="fstat-no" title="function not covered" >checkSessionToken(</span>forceNew?: boolean) {
    const lsReset = <span class="cstat-no" title="statement not covered" >this.sessionStorage.getItem(this.options.session_reset_key) !== null</span>
    const needNewSessionID = <span class="cstat-no" title="statement not covered" >forceNew || lsReset</span>
    const sessionToken = <span class="cstat-no" title="statement not covered" >this.session.getSessionToken()</span>
&nbsp;
...
&nbsp;
   ...
   * */
  public async <span class="fstat-no" title="function not covered" >coldStart(</span>startOpts: StartOptions = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span> conditional?: boolean) {
<span class="cstat-no" title="statement not covered" >    this.singleBuffer = false</span>
    const second = <span class="cstat-no" title="statement not covered" >1000</span>
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (conditional) {</span>
<span class="cstat-no" title="statement not covered" >      this.conditionsManager = new ConditionsManager(this, startOpts)</span>
    }
...
<span class="cstat-no" title="statement not covered" >      this.orderNumber += 1</span>
...
<span class="cstat-no" title="statement not covered" >      if (this.orderNumber % 2 === 0) {</span>
...
<span class="cstat-no" title="statement not covered" >      this.stop(false)</span>
<span class="cstat-no" title="statement not covered" >      this.activityState = ActivityState.ColdStart</span>
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (startOpts.sessionHash) {</span>
...
<span class="cstat-no" title="statement not covered" >    this.coldInterval = setInterval(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
...
&nbsp;
   ...
   * */
  public <span class="fstat-no" title="function not covered" >saveBuffer(</span>) {
<span class="cstat-no" title="statement not covered" >    this.localStorage.setItem(bufferStorageKey, JSON.stringify(this.bufferedMessages1))</span>
  }
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.worker) {</span>
      const reason = <span class="cstat-no" title="statement not covered" >'No worker found: perhaps, CSP is not set.'</span>
...
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (!isColdStart) {</span>
<span class="cstat-no" title="statement not covered" >      adjustTimeOrigin()</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (startOpts.sessionHash) {</span>
...
<span class="cstat-no" title="statement not covered" >    this.sessionStorage.removeItem(this.options.session_reset_key)</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.debug.log(</span>
...
<span class="cstat-no" title="statement not covered" >        if (r.status === 200) {</span>
...
<span class="cstat-no" title="statement not covered" >              text === CANCELED</span>
...
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.activityState === ActivityState.NotActive) {</span>
          const reason = <span class="cstat-no" title="statement not covered" >'Tracker stopped during authorization'</span>
<span class="cstat-no" title="statement not covered" >          this.signalError(reason, [])</span>
<span class="cstat-no" title="statement not covered" >          return Promise.reject(reason)</span>
        }
        const {
...
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (</span>
          ...
          const reason = <span class="cstat-no" title="statement not covered" >`Incorrect server response: ${JSON.stringify(r)}`</span>
<span class="cstat-no" title="statement not covered" >          this.signalError(reason, [])</span>
<span class="cstat-no" title="statement not covered" >          return Promise.reject(reason)</span>
        }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (socketOnly) {</span>
<span class="cstat-no" title="statement not covered" >          this.socketMode = true</span>
...
<span class="cstat-no" title="statement not covered" >        Object.entries(this.session.getInfo().metadata).forEach(<span class="fstat-no" title="function not covered" >([</span>key, value]) =&gt;</span>
<span class="cstat-no" title="statement not covered" >          this.send(Metadata(key, value)),</span>
        )
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (canvasEnabled &amp;&amp; !this.options.disableCanvas) {</span>
...
<span class="cstat-no" title="statement not covered" >        this.session.reset()</span>
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (reason === CANCELED) {</span>
<span class="cstat-no" title="statement not covered" >          this.signalError(CANCELED, [])</span>
...
<span class="cstat-no" title="statement not covered" >        this._debug('session_start', reason)</span>
        const errorMessage = <span class="cstat-no" title="statement not covered" >reason instanceof Error ? reason.message : reason.toString()</span>
<span class="cstat-no" title="statement not covered" >        this.signalError(errorMessage, [])</span>
<span class="cstat-no" title="statement not covered" >        return UnsuccessfulStart(errorMessage)</span>
      })
  }
&nbsp;
...
&nbsp;
   ...
   * */
<span class="fstat-no" title="function not covered" >  start(</span>...args: Parameters&lt;App['_start']&gt;): Promise&lt;StartPromiseReturn&gt; {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (</span>
      this.activityState === ActivityState.Active ||
      this.activityState === ActivityState.Starting
    ) {
...
<span class="cstat-no" title="statement not covered" >        setTimeout(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
<span class="cstat-no" title="statement not covered" >          resolve(this._start(...args))</span>
        }, 25)
      })
    } else {
<span class="cstat-no" title="statement not covered" >      return new Promise(<span class="fstat-no" title="function not covered" >(r</span>esolve) =&gt; {</span>
        const onVisibilityChange = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
<span class="cstat-no" title="statement not covered" >          <span class="missing-if-branch" title="if path not taken" >I</span>if (!document.hidden) {</span>
<span class="cstat-no" title="statement not covered" >            document.removeEventListener('visibilitychange', onVisibilityChange)</span>
<span class="cstat-no" title="statement not covered" >            setTimeout(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
<span class="cstat-no" title="statement not covered" >              resolve(this._start(...args))</span>
            }, 25)
          }
        }
<span class="cstat-no" title="statement not covered" >        document.addEventListener('visibilitychange', onVisibilityChange)</span>
      })
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  forceFlushBatch(</span>) {
<span class="cstat-no" title="statement not covered" >    this.worker?.postMessage('forceFlushBatch')</span>
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  clearBuffers(</span>) {
<span class="cstat-no" title="statement not covered" >    this.bufferedMessages1.length = 0</span>
<span class="cstat-no" title="statement not covered" >    this.bufferedMessages2.length = 0</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        this.canvasRecorder?.clear()</span>
      } finally {
<span class="cstat-no" title="statement not covered" >        this.activityState = ActivityState.NotActive</span>
      }
    }
  }
}
