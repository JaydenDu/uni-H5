...
&nbsp;
export const <span class="cstat-no" title="statement not covered" >InputMode = {</span>
  Plain: 0,
  Obscured: 1,
  Hidden: 2,
} as const
...
&nbsp;
  function <span class="fstat-no" title="function not covered" >getInputValue(</span>id: number, node: TextFieldElement | HTMLSelectElement) {
    ...
    let inputMode: InputModeT = <span class="cstat-no" title="statement not covered" >options.defaultInputMode</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          <span class="missing-if-branch" title="if path not taken" >I</span>if (nodeHesitationTime === 0 &amp;&amp; nodeFocusTime !== 0) {</span>
...
<span class="cstat-no" title="statement not covered" >          <span class="missing-if-branch" title="if path not taken" >I</span>if (nodeFocusTime !== 0) {</span>
...
<span class="cstat-no" title="statement not covered" >          nodeFocusTime = 0</span>
        }
