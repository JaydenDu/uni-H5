...
<head>
    <title>Code coverage report for webworker/BatchWriter.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">webworker</a> BatchWriter.ts</h1>
        <div class='clearfix'>
...
<span class="fstat-no" title="function not covered" >  constructor(</span>
    ...
    private readonly <span class="cstat-no" title="statement not covered" >onOfflineEnd: () =&gt; void,</span>
  ) {
...
<span class="fstat-no" title="function not covered" >  writeMessage(</span>message: Message) {
    // @ts-ignore
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (message[0] === 'q_end') {</span>
<span class="cstat-no" title="statement not covered" >      this.finaliseBatch()</span>
<span class="cstat-no" title="statement not covered" >      return this.onOfflineEnd()</span>
    }
...
<span class="cstat-no" title="statement not covered" >    this.encoder = new MessageEncoder(this.beaconSizeLimit)</span>
<span class="cstat-no" title="statement not covered" >    this.prepare()</span>
<span class="cstat-no" title="statement not covered" >    if (!this.writeWithSize(message)) {</span>
<span class="cstat-no" title="statement not covered" >      console.warn('OpenReplay: beacon size overflow. Skipping large message.', message, this)</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this.finaliseBatch()</span>
    }
    // reset encoder to normal size
<span class="cstat-no" title="statement not covered" >    this.encoder = new MessageEncoder(this.beaconSize)</span>
<span class="cstat-no" title="statement not covered" >    this.prepare()</span>
  }
&nbsp;
