...
<head>
    <title>Code coverage report for main/modules/console.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">main/modules</a> console.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  const patchConsole = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(c</span>onsole: Console, ctx: typeof globalThis) =&gt; {</span>
    const handler = <span class="cstat-no" title="statement not covered" >{</span>
      apply: <span class="fstat-no" title="function not covered" >function (t</span>arget: Console['log'], thisArg: typeof this, argumentsList: unknown[]) {
<span class="cstat-no" title="statement not covered" >        Reflect.apply(target, ctx, argumentsList)</span>
<span class="cstat-no" title="statement not covered" >        n = n + 1</span>
<span class="cstat-no" title="statement not covered" >        if (n &gt; options.consoleThrottling) {</span>
<span class="cstat-no" title="statement not covered" >          return</span>
        } else {
<span class="cstat-no" title="statement not covered" >          sendConsoleLog(target.name, argumentsList)</span>
        }
      },
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        return</span>
      ...
      const fn = (<span class="cstat-no" title="statement not covered" >ctx.console as any)[method]</span>
      // is there any way to preserve the original console trace?
      ;(<span class="cstat-no" title="statement not covered" >console as any)[method] = new Proxy(fn, handler)</span>
    })
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    patchConsole(context.console, context),</span>
  )
&nbsp;
