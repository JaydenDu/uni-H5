...
<head>
    <title>Code coverage report for main/modules/Network/xhrProxy.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">main/modules/Network</a> xhrProxy.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >            <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.tokenUrlMatcher(this.item.url)) {</span>
...
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.item.url &amp;&amp; this.isServiceUrl(this.item.url)) <span class="cstat-no" title="statement not covered" >return</span></span>
...
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >(.</span>..args: any[]) =&gt; {</span>
...
&nbsp;
  protected <span class="fstat-no" title="function not covered" >getSend(</span>target: T) {
...
&nbsp;
  protected <span class="fstat-no" title="function not covered" >getSetRequestHeader(</span>target: T) {
    const targetFunction = <span class="cstat-no" title="statement not covered" >Reflect.get(target, 'setRequestHeader')</span>
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >(.</span>..args: any[]) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.item.requestHeader) {</span>
...
&nbsp;
  protected <span class="fstat-no" title="function not covered" >setOnAbort(</span>target: T, key: string, oaFunction: (args: any[]) =&gt; any) {
<span class="cstat-no" title="statement not covered" >    return Reflect.set(target, key, <span class="fstat-no" title="function not covered" >(.</span>..args: any[]) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.onAbort()</span>
...
&nbsp;
  protected <span class="fstat-no" title="function not covered" >setOnTimeout(</span>target: T, key: string, otFunction: (args: any[]) =&gt; any) {
<span class="cstat-no" title="statement not covered" >    return Reflect.set(target, key, <span class="fstat-no" title="function not covered" >(.</span>..args: any[]) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.onTimeout()</span>
...
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.item.startTime) {</span>
...
<span class="cstat-no" title="statement not covered" >        for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; headerArr.length; i++) {</span>
          const line = <span class="cstat-no" title="statement not covered" >headerArr[i]</span>
<span class="cstat-no" title="statement not covered" >          <span class="missing-if-branch" title="if path not taken" >I</span>if (!line) {</span>
...
<span class="cstat-no" title="statement not covered" >        this.item.status = this.XMLReq.status</span>
<span class="cstat-no" title="statement not covered" >        this.item.statusText = 'Loading'</span>
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (!!this.XMLReq.response &amp;&amp; this.XMLReq.response.length) {</span>
...
<span class="fstat-no" title="function not covered" >      construct(</span>original: any) {
