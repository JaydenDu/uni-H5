...
<span class="cstat-no" title="statement not covered" >import SignalManager from './SignalManager.js'</span>
&nbsp;
interface Test {
  title: string
  description: string
...
<span class="cstat-no" title="statement not covered" >export default class U</span>serTestManager {
  ...
  public <span class="cstat-no" title="statement not covered" >isActive = false</span>
...
<span class="cstat-no" title="statement not covered" >      this.app.localStorage.removeItem(TEST_ID)</span>
<span class="cstat-no" title="statement not covered" >      this.app.localStorage.removeItem(TASK_IND)</span>
<span class="cstat-no" title="statement not covered" >      this.app.localStorage.removeItem(TEST_START)</span>
    }
&nbsp;
    const taskIndex = <span class="cstat-no" title="statement not covered" >this.app.localStorage.getItem(TASK_IND)</span>
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (taskIndex) {</span>
<span class="cstat-no" title="statement not covered" >      this.currentTaskIndex = parseInt(taskIndex, 10)</span>
    }
  }
&nbsp;
  public <span class="fstat-no" title="function not covered" >getTestId(</span>) {
<span class="cstat-no" title="statement not covered" >    return this.testId</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  getTest = <span class="fstat-no" title="function not covered" >(i</span>d: number, token: string, inProgress?: boolean) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    this.testId = id</span>
    const ingest = <span class="cstat-no" title="statement not covered" >this.app.options.ingestPoint</span>
<span class="cstat-no" title="statement not covered" >    return fetch(`${ingest}/v1/web/uxt/test/${id}`, {</span>
      headers: {
      ...
      .then(<span class="fstat-no" title="function not covered" >({</span> test }: { test: Test }) =&gt; {
...
<span class="cstat-no" title="statement not covered" >          <span class="missing-if-branch" title="if path not taken" >I</span>if (test.reqMic || test.reqCamera) {</span>
<span class="cstat-no" title="statement not covered" >            void this.userRecorder.startRecording(30, Quality.Standard, test.reqMic, test.reqCamera)</span>
          }
<span class="cstat-no" title="statement not covered" >          this.showWidget(test.description, test.tasks, true)</span>
<span class="cstat-no" title="statement not covered" >          this.showTaskSection()</span>
        }
      })
      .then(<span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >id)</span>
      .catch(<span class="fstat-no" title="function not covered" >(e</span>rr) =&gt; {
<span class="cstat-no" title="statement not covered" >        console.log('OR: Error fetching test', err)</span>
      })
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  removeGreeting = <span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >false</span></span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.removeGreeting = <span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
      // this.container.innerHTML = ''
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (micRequired || cameraRequired) {</span>
<span class="cstat-no" title="statement not covered" >        void this.userRecorder.startRecording(30, Quality.Standard, micRequired, cameraRequired)</span>
      }
<span class="cstat-no" title="statement not covered" >      this.container.removeChild(buttonElement)</span>
<span class="cstat-no" title="statement not covered" >      this.container.removeChild(descriptionElement)</span>
<span class="cstat-no" title="statement not covered" >      this.container.removeChild(titleElement)</span>
...
<span class="cstat-no" title="statement not covered" >      this.removeGreeting()</span>
      const durations = <span class="cstat-no" title="statement not covered" >this.signalManager?.getDurations()</span>
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (durations &amp;&amp; this.signalManager) {</span>
<span class="cstat-no" title="statement not covered" >        durations.testStart = this.app.timestamp()</span>
<span class="cstat-no" title="statement not covered" >        this.signalManager.setDurations(durations)</span>
      }
<span class="cstat-no" title="statement not covered" >      void this.signalManager?.signalTest('begin')</span>
<span class="cstat-no" title="statement not covered" >      this.container.style.fontFamily = `-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"`</span>
<span class="cstat-no" title="statement not covered" >      Object.assign(this.container.style, styles.containerWidgetStyle)</span>
<span class="cstat-no" title="statement not covered" >      this.showWidget(this.test?.guidelines || '', this.test?.tasks || [])</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.container.append(titleElement, descriptionElement, buttonElement)</span>
...
<span class="cstat-no" title="statement not covered" >    this.container.style.fontFamily = `-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"`</span>
<span class="cstat-no" title="statement not covered" >    Object.assign(this.container.style, styles.containerWidgetStyle)</span>
    const descriptionSection = <span class="cstat-no" title="statement not covered" >this.createDescriptionSection(guidelines)</span>
    ...
    const stopContainer = <span class="cstat-no" title="statement not covered" >createElement('div', 'stop_ct_or', { fontSize: '13px!important' })</span>
<span class="cstat-no" title="statement not covered" >    stopContainer.style.fontSize = '13px'</span>
<span class="cstat-no" title="statement not covered" >    stopContainer.append(stopButton)</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.container.append(titleSection, descriptionSection, tasksSection, stopContainer)</span>
...
<span class="cstat-no" title="statement not covered" >      this.toggleDescriptionVisibility()</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  createTitleSection(</span>) {
    ...
    const leftIcon = <span class="cstat-no" title="statement not covered" >generateGrid()</span>
    const titleText = <span class="cstat-no" title="statement not covered" >createElement(</span>
      'div',
      'title_text',
      {
        maxWidth: '19rem',
    ...
    const rightIcon = <span class="cstat-no" title="statement not covered" >generateChevron()</span>
&nbsp;
...
&nbsp;
    const collapseWidget = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
<span class="cstat-no" title="statement not covered" >      Object.assign(rightIcon.style, {</span>
        transform: this.widgetVisible ? 'rotate(0deg)' : 'rotate(180deg)',
      })
<span class="cstat-no" title="statement not covered" >      toggleWidget(!this.widgetVisible)</span>
    }
<span class="cstat-no" title="statement not covered" >    titleText.onclick = collapseWidget</span>
<span class="cstat-no" title="statement not covered" >    rightIcon.onclick = collapseWidget</span>
...
<span class="cstat-no" title="statement not covered" >  toggleDescriptionVisibility = <span class="fstat-no" title="function not covered" >() =</span>&gt; {}</span>
&nbsp;
<span class="fstat-no" title="function not covered" >  createDescriptionSection(</span>guidelines: string) {
    ...
    const descriptionC = <span class="cstat-no" title="statement not covered" >createElement('div', 'text_description', {</span>
      maxHeight: '250px',
      overflowY: 'auto',
      whiteSpace: 'pre-wrap',
      fontSize: 13,
...
<span class="cstat-no" title="statement not covered" >    descriptionC.innerHTML = guidelines</span>
...
<span class="cstat-no" title="statement not covered" >    content.append(descriptionC, button)</span>
...
<span class="cstat-no" title="statement not covered" >    this.toggleDescriptionVisibility = <span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.widgetGuidelinesVisible = false</span>
<span class="cstat-no" title="statement not covered" >      icon.textContent = this.widgetGuidelinesVisible ? '-' : '+'</span>
<span class="cstat-no" title="statement not covered" >      Object.assign(</span>
        content.style,
        this.widgetGuidelinesVisible ? styles.contentStyle : { display: 'none' },
      )
<span class="cstat-no" title="statement not covered" >      content.removeChild(button)</span>
    }
...
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.test) {</span>
        const durations = <span class="cstat-no" title="statement not covered" >this.signalManager?.getDurations()</span>
        const taskDurationInd = <span class="cstat-no" title="statement not covered" >durations</span>
          ? durations.tasks.findIndex(<span class="fstat-no" title="function not covered" >(t</span>) =&gt; <span class="cstat-no" title="statement not covered" >this.test &amp;&amp; t.taskId === this.test.tasks[0].task_id)</span>
          : null
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (durations &amp;&amp; taskDurationInd === -1) {</span>
<span class="cstat-no" title="statement not covered" >          durations.tasks.push({</span>
            taskId: this.test.tasks[0].task_id,
            started: this.app.timestamp(),
          })
<span class="cstat-no" title="statement not covered" >          this.signalManager?.setDurations(durations)</span>
        }
<span class="cstat-no" title="statement not covered" >        void this.signalManager?.signalTask(this.test.tasks[0].task_id, 'begin')</span>
      }
<span class="cstat-no" title="statement not covered" >      this.showTaskSection()</span>
<span class="cstat-no" title="statement not covered" >      content.removeChild(button)</span>
    }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  currentTaskIndex = 0</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    Object.assign(this.container.style, styles.containerWidgetStyle)</span>
    ...
    const inputTitle = <span class="cstat-no" title="statement not covered" >createElement('div', 'taskText', styles.taskTextStyle)</span>
<span class="cstat-no" title="statement not covered" >    inputTitle.textContent = 'Your answer'</span>
    const inputArea = <span class="cstat-no" title="statement not covered" >createElement('textarea', 'taskDescription', {</span>
      resize: 'vertical',
    }) as HTMLTextAreaElement
    const inputContainer = <span class="cstat-no" title="statement not covered" >createElement('div', 'inputArea', styles.taskDescriptionCard)</span>
<span class="cstat-no" title="statement not covered" >    inputContainer.append(inputTitle, inputArea)</span>
...
<span class="cstat-no" title="statement not covered" >    content.append(pagination, taskCard, inputContainer, taskButtons)</span>
<span class="cstat-no" title="statement not covered" >    section.append(titleContainer, content)</span>
&nbsp;
    const updateTaskContent = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
      const task = <span class="cstat-no" title="statement not covered" >tasks[this.currentTaskIndex]</span>
...
<span class="cstat-no" title="statement not covered" >      if (task.allow_typing) {</span>
<span class="cstat-no" title="statement not covered" >        inputContainer.style.display = 'flex'</span>
      } else {
<span class="cstat-no" title="statement not covered" >        inputContainer.style.display = 'none'</span>
      }
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    tasks.forEach(<span class="fstat-no" title="function not covered" >(_</span>, index) =&gt; {</span>
      const pageNumber = <span class="cstat-no" title="statement not covered" >createElement(</span>
        'span',
        `or_task_${index}`,
        {
...
&nbsp;
    const highlightActive = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
      const activeTaskEl = <span class="cstat-no" title="statement not covered" >document.getElementById(`or_task_${this.currentTaskIndex}`)</span>
...
<span class="cstat-no" title="statement not covered" >      for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; this.currentTaskIndex; i++) {</span>
...
<span class="cstat-no" title="statement not covered" >    nextButton.onclick = <span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
      const textAnswer = <span class="cstat-no" title="statement not covered" >tasks[this.currentTaskIndex].allow_typing ? inputArea.value : undefined</span>
<span class="cstat-no" title="statement not covered" >      inputArea.value = ''</span>
<span class="cstat-no" title="statement not covered" >      void this.signalManager?.signalTask(tasks[this.currentTaskIndex].task_id, 'done', textAnswer)</span>
<span class="cstat-no" title="statement not covered" >      if (this.currentTaskIndex &lt; tasks.length - 1) {</span>
<span class="cstat-no" title="statement not covered" >        this.currentTaskIndex++</span>
...
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (</span>
          durations &amp;&amp;
          durations.tasks.findIndex(<span class="fstat-no" title="function not covered" >(t</span>) =&gt; <span class="cstat-no" title="statement not covered" >t.taskId === tasks[this.currentTaskIndex].task_id)</span> === -1
        ) {
<span class="cstat-no" title="statement not covered" >          durations.tasks.push({</span>
...
<span class="cstat-no" title="statement not covered" >        void this.signalManager?.signalTask(tasks[this.currentTaskIndex].task_id, 'begin')</span>
<span class="cstat-no" title="statement not covered" >        highlightActive()</span>
      } else {
<span class="cstat-no" title="statement not covered" >        this.showEndSection()</span>
      }
<span class="cstat-no" title="statement not covered" >      this.app.localStorage.setItem('or_uxt_task_index', this.currentTaskIndex.toString())</span>
    }
&nbsp;
...
<span class="fstat-no" title="function not covered" >  showEndSection(</span>) {
    let isLoading = <span class="cstat-no" title="statement not covered" >true</span>
<span class="cstat-no" title="statement not covered" >    void this.signalManager?.signalTest('done')</span>
    ...
    const button = <span class="cstat-no" title="statement not covered" >createElement(</span>
      'div',
      'end_button_or',
      styles.buttonWidgetStyle,
      'Submitting Feedback',
    )
    const spinner = <span class="cstat-no" title="statement not covered" >createSpinner()</span>
<span class="cstat-no" title="statement not covered" >    button.appendChild(spinner)</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.test?.reqMic || this.test?.reqCamera) {</span>
<span class="cstat-no" title="statement not covered" >      void this.userRecorder</span>
        .sendToAPI()
        .then(<span class="fstat-no" title="function not covered" >() =</span>&gt; {
<span class="cstat-no" title="statement not covered" >          button.removeChild(spinner)</span>
<span class="cstat-no" title="statement not covered" >          button.textContent = 'End Session'</span>
<span class="cstat-no" title="statement not covered" >          isLoading = false</span>
        })
        .catch(<span class="fstat-no" title="function not covered" >(e</span>rr) =&gt; {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    button.onclick = <span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (isLoading) <span class="cstat-no" title="statement not covered" >return</span></span>
<span class="cstat-no" title="statement not covered" >      window.close()</span>
<span class="cstat-no" title="statement not covered" >      document.body.removeChild(this.bg)</span>
    }
