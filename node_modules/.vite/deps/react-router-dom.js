...
// node_modules/.pnpm/react-router-dom@https+++registry.npmmirror.com+react-router-dom+-+react-router-dom-6.19.0.tg_bme7oikotz2ik7mv6mhc3c4ulu/node_modules/react-router-dom/dist/index.js
init_compat_module();
init_compat_module();

// node_modules/.pnpm/react-router@https+++registry.npmmirror.com+react-router+-+react-router-6.19.0.tgz_react@18.2.0/node_modules/react-router/dist/index.js
init_compat_module();

// node_modules/.pnpm/@remix-run+router@https+++registry.npmmirror.com+@remix-run+router+-+router-1.12.0.tgz/node_modules/@remix-run/router/dist/router.js
function _extends() {
...
var RenderErrorBoundary = class extends b {
  ...
  render() {
    return this.state.error ? y(RouteContext.Provider, {
...
function Navigate(_ref4) {
  ...
  true ? warning(!q(NavigationContext).static, "<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.") : void 0;
  let {
    matches
  } = q(RouteContext);
  let {
...
function RouterProvider(_ref) {
  ...
  return y(g, null, y(DataRouterContext.Provider, {
    ...
    navigator
  }, state.initialized ? y(DataRoutes, {
