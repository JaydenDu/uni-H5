...
// node_modules/.pnpm/styled-components@6.1.12_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/styled-components/dist/styled-components.browser.esm.js
init_compat_module();
...
function prefix(value, length2, children) {
  switch (hash(value, length2)) {
    ...
    case 5152:
    case 5920:
      return replace(value, /(.+?):(\d+)(\s*\/\s*(span)?\s*(\d+))?(.*)/, function(_3, a, b2, c, d, e, f2) {
...
var P = function(t, n) {
  if (true) {
    ...
    try {
      ...
      }, _(), a && !N.has(s) && (console.warn(s), N.add(s));
    } catch (e) {
...
function Fe(e) {
  var t, n, o, r = void 0 === e ? C : e, s = r.options, i = void 0 === s ? C : s, a = r.plugins, c = void 0 === a ? _2 : a, l = function(e2, o2, r2) {
  ...
  return p3.hash = c.length ? c.reduce(function(e2, t2) {
    return t2.name || he(15), M(e2, t2.name);
  }, F2).toString() : "", p3;
}
var Me = new ke();
var ze = Fe();
var $e = wn.createContext({ shouldForwardProp: void 0, styleSheet: Me, stylis: ze });
var Be = $e.Consumer;
var Le = wn.createContext(void 0);
function Ge() {
  return q($e);
}
function Ye(e) {
  var t = h(e.stylisPlugins), n = t[0], r = t[1], c = Ge().styleSheet, l = F(function() {
    var t2 = c;
  ...
  }, [e.disableCSSOMInjection, e.sheet, e.target, c]), u = F(function() {
  ...
  return wn.createElement($e.Provider, { value: d }, wn.createElement(Le.Provider, { value: u }, e.children));
}
var We = function() {
  function e(e2, t) {
    var n = this;
...
function Xe(e, t, n, o) {
  ...
  var s;
  return e instanceof We ? n ? (e.inject(n, o), [e.getName(o)]) : [e] : ce(e) ? Je(e) : Array.isArray(e) ? Array.prototype.concat.apply(_2, e.map(function(e2) {
    return Xe(e2, t, n, o);
  })) : [e.toString()];
}
function Ze(e) {
...
var et = wn.createContext(void 0);
var tt = et.Consumer;
function nt() {
  var e = q(et);
  if (!e) throw he(18);
...
function ot(e) {
  var n = wn.useContext(et), r = F(function() {
  ...
  return e.children ? wn.createElement(et.Provider, { value: r }, e.children) : null;
}
var rt = {};
var st = /* @__PURE__ */ new Set();
function it(e, r, s) {
  var i = se(e), a = e, c = !L(e), p3 = r.attrs, d = void 0 === p3 ? _2 : p3, h2 = r.componentId, f2 = void 0 === h2 ? function(e2, t) {
  ...
  function O2(e2, r2) {
    return function(e3, r3, s2) {
      var i2 = e3.attrs, a2 = e3.componentStyle, c2 = e3.defaultProps, p4 = e3.foldedComponentIds, d2 = e3.styledComponentId, h3 = e3.target, f3 = wn.useContext(et), m3 = Ge(), y4 = e3.shouldForwardProp || m3.shouldForwardProp;
      x(d2);
      ...
      for (var b3 in g3) void 0 === g3[b3] || "$" === b3[0] || "as" === b3 || "theme" === b3 && g3.theme === v2 || ("forwardedAs" === b3 ? w3.as = g3.forwardedAs : y4 && !y4(b3, S3) || (w3[b3] = g3[b3], y4 || false || isPropValid(b3) || st.has(b3) || !A.has(S3) || (st.add(b3), console.warn('styled-components: it looks like an unknown prop "'.concat(b3, '" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)')))));
      ...
      var N3 = ie(p4, d2);
      return E3 && (N3 += " " + E3), g3.className && (N3 += " " + g3.className), w3[L(S3) && !A.has(S3) ? "class" : "className"] = N3, w3.ref = s2, y(S3, w3);
    }(D2, e2, r2);
  }
  O2.displayName = y3;
  var D2 = wn.forwardRef(O2);
  return D2.attrs = S2, D2.componentStyle = N2, D2.displayName = y3, D2.shouldForwardProp = w2, D2.foldedComponentIds = i ? ie(a.foldedComponentIds, a.styledComponentId) : "", D2.styledComponentId = g2, D2.target = i ? a.target : e, Object.defineProperty(D2, "defaultProps", { get: function() {
  ...
  } }), P(y3, g2), D2.warnTooManyClasses = /* @__PURE__ */ function(e2, t) {
    var n = {}, o = false;
    return function(r2) {
...
function lt(t) {
  for (var n = [], o = 1; o < arguments.length; o++) n[o - 1] = arguments[o];
  if (re(t) || ce(t)) return ct(Xe(at(_2, __spreadArray([t], n, true))));
  var r = t;
...
function ft(n) {
  ...
  P(a);
  var l = function(e) {
    var t = Ge(), n2 = wn.useContext(et), r2 = wn.useRef(t.styleSheet.allocateGSInstance(a)).current;
    return wn.Children.count(e.children) && console.warn("The global style component ".concat(a, " was given child JSX. createGlobalStyle does not render children.")), i.some(function(e2) {
      return "string" == typeof e2 && -1 !== e2.indexOf("@import");
    }) && console.warn("Please do not use @import CSS syntax in createGlobalStyle at this time, as the CSSOM APIs we use in production do not handle it well. Instead, we recommend using a library such as react-helmet to inject a typical <link> meta tag to the stylesheet, or simply embedding it manually in your index.html <head> section for a simpler app."), t.styleSheet.server && u(r2, e, t.styleSheet, n2, t.stylis), wn.useLayoutEffect(function() {
...
function yt(e) {
  var n = wn.forwardRef(function(n2, r) {
    var s = I(n2, wn.useContext(et), e.defaultProps);
    return void 0 === s && console.warn('[withTheme] You are not using a ThemeProvider nor passing a theme prop or a theme in defaultProps in component class "'.concat(B(e), '"')), wn.createElement(e, __assign({}, n2, { theme: s, ref: r }));
  });
...
var vt = function() {
  function e() {
    ...
    this._emitSheetCSS = function() {
      ...
      return i && (s.nonce = i), [wn.createElement("style", __assign({}, s, { key: "sc-0-0" }))];
    }, this.seal = function() {
      e2.sealed = true;
  ...
  return e.prototype.collectStyles = function(e2) {
    ...
    return wn.createElement(Ye, { sheet: this.instance }, e2);
